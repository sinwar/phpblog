...
<nav>
    <div class="nav-wrapper green">
      ...
      <li><a href="login.php" class="text-center btn waves-effect waves-light white lighten-2" style="padding-right:2em;color:black;">Login</a></li>
      </ul>
...
<div class="container" style="width:60%">
  <h2 style="text-align:center; font-weight:bold; margin-bottom: 10%;">Sign Up</h2>
  <div class="row">
    <form class="col s12" method="post">
      <div class="row">
        <div class="input-field col s12">
          <input id="firstname" type="text" class="validate" name="firstname" autofocus required>
          <label for="firstname" style="color:green; font-size: 20px;">Firstname</label>
        </div>
        </div>
    ...
    <div class="row">
        <div class="input-field col s12">
          ...
          <label for="username" style="color:green; font-size: 20px;">Username</label>
        </div>
        </div>
    ...
    <div class="row">
        <div class="input-field col s12">
          ...
          <label for="password" style="color:green; font-size: 20px;">Password</label>
        </div>
        </div>
     <div class="form-group has-feedback" id="con_pwdiv">
      <label for="password" style="color:green; font-size: 20px;">Confirm Password:</label>
   ...
   <button class="btn waves-effect waves-light green" type="submit" name="submit">Submit<i class="material-icons right">send</i>
    </button>
  </form>
</div>
<?php
