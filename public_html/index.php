...
<body style="font-family:'Lora',serif;">
  ...
  <nav>
    <div class="nav-wrapper green">
      ...
      <li><a href="signup.php" class="btn waves-effect waves-light white lighten-2" style="padding-right:2em;color:black;">Sign Up</a></li>
      <li><a href="login.php" class="btn waves-effect waves-light white lighten-2" style="padding-right:2em;color:black;">Login</a></li>
      </ul>
