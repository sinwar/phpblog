 ...
 <div class="navbar-fixed ">
  <nav>
    <div class="nav-wrapper green">
      ...
      <li><a href="signup.php" class="text-center btn waves-effect waves-light white lighten-2" style="padding-right:2em;color:black;">Sign Up</a></li>
      </ul>
...
<div class="container" style="width:60%">
  <h2 style="text-align:center; font-weight:bold; margin-bottom: 10%;">Log IN</h2>
