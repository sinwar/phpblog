...
<div class="navbar-fixed ">
  <nav>
    <div class="nav-wrapper green">
      ...
      <li><a href="write-blog.php" class="btn waves-effect waves-light white lighten-2" style="padding-right:2em;color:black;">Write</a></li>
      <li><a href="userhome.php?logout" class="btn waves-effect waves-light white lighten-2" style="padding-right:2em;color:black;">Logout</a></li>
      </ul>
...
if ($blogs == false) {
    ...
    while ($i < count($blogs)) {
        $word_limit = '10';
        echo '<div class="row">
    <div class="col-md-8 col-md-offset-2" style="padding:10em;">
    ...
    <span class="card-title">' . $blogs[$i][1] . '<h6 class="flow-text grey-text">' . $blogs[$i][3] . ',' . $blogs[$i][4];
      ...
      <a href = "update.php?blog_id=' . $blogs[$i][0] . '" style="color:green; font-weight:bold;">update</a><a href ="view-blog.php?blog_id=' . $blogs[$i][0] . '&username=' . $username . '" style="color:green; font-weight:bold;">Read More</a></div>';
